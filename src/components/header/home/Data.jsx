...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className='home_title'>Chanisa Jay
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className='home__subtitle'>Tech Geek</h3>
            <p className="home__description">A passionate software engineering trainee with a hunger for cutting-edge I.T. technologies.
            </p>
            <button class="button rounded-full shadow-md">
                Say Hello
